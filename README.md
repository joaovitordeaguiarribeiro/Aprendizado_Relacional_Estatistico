...
### [cite_start]Pré-requisitos [cite: 132, 241]
1. [cite_start]Ter o motor do [SWI-Prolog](https://www.swi-prolog.org/) instalado e configurado nas variáveis de ambiente (`PATH`) do sistema operacional[cite: 132].
2. [cite_start]Ter o Python 3.x instalado[cite: 131].

### [cite_start]Instalação das Dependências [cite: 241]
